...
class _MainDrawerState extends State<MainDrawer> {
  final _userImage = UserProfileHeaderWidgetState().userProfileImageList;
  late final MainDrawerBloc _bloc;
  late final UserProfileImageBloc _blocForImage;
  ...
  void initState() {
    ...
    _blocForImage = UserProfileImageBloc();
  }
  ...
  void dispose() {
    super.dispose();
    _bloc.dispose();
    _blocForImage.disposeImageStream();
  }
  @override
                        ...
                        Center(
                          child: Container(
                            ...
                            child: Stack(
                              children: [
                                StreamBuilder(
                                  stream: _blocForImage.streamPersonalDataForDrawer,
                                  builder: (BuildContext context, AsyncSnapshot snapshot) {
                                    if (snapshot.data is LoadedImageUserProfileForDrawer) {
                                      print(snapshot.data);
                                      print('111111111111111111111111111111111111111111111');
                                      final data = snapshot.data as LoadedImageUserProfileForDrawer;
                                      final _image = data.image as File;
                                      return ClipOval(
